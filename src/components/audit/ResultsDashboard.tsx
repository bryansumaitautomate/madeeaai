    ...
    <div className="relative p-5 sm:p-8 rounded-2xl sm:rounded-3xl bg-white/[0.02] backdrop-blur-xl border border-white/[0.08] overflow-hidden">
      ...
      <div className="relative">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          ...
          <Button type="submit" disabled={isSubmitting} className="group relative p-[1px] w-auto self-center overflow-hidden rounded-lg border-0 bg-transparent hover:bg-transparent h-auto">
