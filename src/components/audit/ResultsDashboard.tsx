    ...
    <div className="relative p-5 sm:p-8 rounded-2xl sm:rounded-3xl bg-white/[0.02] backdrop-blur-xl border border-white/[0.08] overflow-hidden">
      ...
      <div className="relative">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          ...
          <Button type="submit" disabled={isSubmitting} className="group relative p-[1px] inline-flex items-center justify-center overflow-hidden rounded-lg border-0 bg-transparent hover:bg-transparent h-auto">
            <span className="absolute inset-[-1000%] animate-[spin_3s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#3B82F6_0%,#60A5FA_50%,#3B82F6_100%)]" />
            <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-[7px] bg-black px-6 py-2 text-sm font-semibold text-white backdrop-blur-3xl transition-all group-hover:bg-black/90 gap-2">
