      ...
      <header
        className={cn(
          ...
          isScrolled
            ...
            : 'bg-[#0a0a0f]/60 backdrop-blur-md border-b border-white/5'
        )}
      >
        <nav className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-8">
            {navLinks.map((link) => (
              <a
                ...
                className="nav-link relative text-xs font-mono uppercase tracking-widest text-muted-foreground hover:text-foreground transition-all duration-300 py-2"
              >
                {link.label}
              </a>
            ))}
          ...
          <button
            ...
            className="lg:hidden relative z-50 w-10 h-10 flex items-center justify-center rounded-lg border border-white/10 bg-card/50 backdrop-blur-sm hover:border-primary/30 transition-all duration-300"
