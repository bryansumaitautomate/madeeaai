    ...
    <section className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          <p className="mono-data text-primary mb-4">// Client Signals</p>
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif tracking-tight text-foreground">
              ...
              {testimonials.map((testimonial, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`
                        glass-infrastructure rounded-2xl p-8 md:p-10
                    ...
                    >
                      ...
                      {testimonial.featured && position === 'center' && (
                        ...
                        >
                          <span className="mono-data px-4 py-1.5 rounded-full bg-primary/20 border border-primary/30 text-primary shadow-[0_0_20px_hsl(var(--primary)/0.3)]">
                            Featured
                          </span>
                        </motion.div>
                      )}
                      ...
                      {/* Quote Text */}
                      <blockquote className="text-lg md:text-xl text-foreground font-light leading-relaxed mb-8">
                        "{testimonial.quote}"
                      </blockquote>
            ...
            {testimonials.map((_, index) => (
              <button
                ...
                className={`
                  ...
                  ${index === activeIndex 
                    ? 'w-6 bg-primary shadow-[0_0_10px_hsl(var(--primary)/0.5)]' 
